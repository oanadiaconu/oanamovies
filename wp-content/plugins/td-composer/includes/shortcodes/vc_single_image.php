...
class vc_single_image extends td_block {
	...
	function render($atts, $content = null) {
		...
		if ( !empty($atts['image']) ) {
			...
			href="' . esc_url( $atts['image_url'] ) . '" ' . $target . $data_ga_event_cat . $data_ga_event_action . $data_ga_event_label . $data_fb_event_name . $data_fb_event_cotent_name . $td_link_rel . ' >';
