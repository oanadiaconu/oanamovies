...
add_action('get_footer', function () {
    ...
    $tda_essential_css = get_post_meta($ref_id,'tda_essential_css', true);
    if ( !empty($tda_essential_css) && !empty($tda_essential_css) && defined('TD_ANALYZE_CSS_CACHE_DIR' ) ) {
...
function load_front_css_remove() {
    ...
    if ( !empty($tda_essential_css) ) {
        ...
        wp_dequeue_style('td-multipurpose');
        wp_dequeue_style('td-standard-pack-framework-front-style-less');
        wp_dequeue_style('tdb_front_style');
        wp_dequeue_style('td-legacy-framework-front-style-less');
        wp_dequeue_style('td-legacy-framework-front-style');
    }
}
